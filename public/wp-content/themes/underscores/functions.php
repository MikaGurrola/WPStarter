...
function underscores_scripts() {
	...
	wp_enqueue_style('style', '/wp-content/themes/underscores/library/css/main.css', array(), 'underscores');

	wp_enqueue_script('main', '/wp-content/themes/underscores/library/js/main.js', array('jquery'), 'underscores', false);

	wp_enqueue_script( 'underscores-navigation', get_template_directory_uri() . '/library/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'underscores-skip-link-focus-fix', get_template_directory_uri() . '/library/js/skip-link-focus-fix.js', array(), '20151215', true );
